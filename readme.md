...
| [Round 19](uef-findings-round19.md) | UEF 2.x | PRO Template Themes, PRO Template Header Links, Badge (w/Border), Show/Hide with Badge, Figure, Summary (Show/Hide), Mega-Select (Radio), Mega-Select (Check), Button (Toggle), Table - Chart View - Advanced Filter - Column Settings - Reorder - Show/Hide | August 17-21, 2020 |
